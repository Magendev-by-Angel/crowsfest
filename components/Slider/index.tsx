...
const Slider = ({ time, setTime }: Props) => {
  ...
  return (
    <>
      <Flex position="relative" h="239px" borderRadius="md" direction="column">
        ...
        <Flex position="relative" h="239px" borderRadius="md">
          <Flex
            ...
            align="center"
            h={{ base: `${478 / 2}px`, md: "478px" }}
          >
            {shuffledIcons.map((item, i) => {
              return (
                <Flex
                  zIndex={1}
                  w={{ base: `${360 / 2}px`, md: "360px" }}
                  h={{ base: `${239 / 2}px`, md: "239px" }}
                  _hover={{
                    w: { base: "360px", md: "720px" },
                    h: { base: "239px", md: "478px" },
                  }}
                  align="flex-end"
                  objectFit="cover"
                  key={i}
                ...
                >
                  <Img w="100%" h="100%" src={item} alt={`slide-icon-${i}`} />
                </Flex>
              );
            })}
          </Flex>
